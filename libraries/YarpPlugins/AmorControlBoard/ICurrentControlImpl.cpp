...
bool AmorControlBoard::getCurrent(int m, double *curr)
{
    ...
    {
        yCError(ACB, "amor_get_actual_currents() failed: %s", amor_error());
        return false;
    }
...
bool AmorControlBoard::getCurrentRange(int m, double *min, double *max)
{
    ...
    {
        yCError(ACB, "amor_get_joint_info() failed: %s", amor_error());
        return false;
    }
...
bool AmorControlBoard::setRefCurrents(const double *currs)
{
    ...
    {
        yCError(ACB, "amor_set_currents() failed: %s", amor_error());
        return false;
    }
...
bool AmorControlBoard::getRefCurrents(double *currs)
{
    ...
    {
        yCError(ACB, "amor_get_req_currents() failed: %s", amor_error());
        return false;
    }
